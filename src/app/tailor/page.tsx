...
import { TailorForm } from "@/components/resume/tailor-form";
  ...
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-6 py-10">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold">Resume Tailoring Engine</h1>
          <p className="mt-1 text-sm text-zinc-600">
            Generate ATS-optimized, job-specific resumes from your verified base profile.
          </p>
        </div>
